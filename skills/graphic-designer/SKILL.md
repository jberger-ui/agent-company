...
description: Use when a draft blog post needs visual concepts, image planning, placement guidance, or a packaged set of recommended visual assets.
metadata:
  sources:
    - kind: github-file
      repo: jberger-ui/agent-company
      path: skills/graphic-designer/SKILL.md
      commit: main
      trackingRef: main
      url: https://github.com/jberger-ui/agent-company/blob/main/skills/graphic-designer/SKILL.md
      usageMode: mirrored
---
